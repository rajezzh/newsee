            ...
            showDialog(
              ...
              builder: (BuildContext context) {
                ...
                return Dialog(
                  ...
                  //             children: [
                  //               buildInRow(context, Icons.person, "Name", 
                  //               [
                  //                 state.cifResponseModel?.lpretLeadDetails['lleadfrstname'] ?? '',
                  //                 state.cifResponseModel?.lpretLeadDetails['lleadmidname'] ?? '',
                  //                 state.cifResponseModel?.lpretLeadDetails['lleadlastname'] ?? '',
                  ...
                  //               ),
                  //               buildInRow(context, Icons.date_range, "DOB", formattedDate),
                  //               buildInRow(context, Icons.call, "Mobile", state.cifResponseModel?.lpretLeadDetails['lleadmobno']),
                  //               buildInRow(context, Icons.chrome_reader_mode_rounded, "PAN", state.cifResponseModel?.lpretLeadDetails['lleadpanno']),
                  //               buildInRow(context, Icons.elevator_rounded, "AAdhaar", state.cifResponseModel?.lpretLeadDetails['lleadadharno']),
                  //               buildInRow(context, Icons.home, "Address", 
                  //                 [
                  //                   state.cifResponseModel?.lpretLeadDetails['lleadaddress'] ?? '',
                  //                   state.cifResponseModel?.lpretLeadDetails['lleadaddresslane1'] ?? '',
                  //                   state.cifResponseModel?.lpretLeadDetails['lleadaddresslane2'] ?? ''
                  //                 ].where((val) => val.isNotEmpty).join(' ')
                  //               ),
                  //               buildInRow(context, Icons.format_list_numbered_rtl_rounded, "Pinocode", state.cifResponseModel?.lpretLeadDetails['lleadpinno']),
                  //             ],
                  //           ),
                  //         ),
                  //       ),
