...
//           if (state.fetchStatus == SubmitStatus.success ||
//               state.fetchStatus == SubmitStatus.failure) {
...
//               //     state.fetchStatus == SubmitStatus.loading)
//               //   const LoadingOverlay(message: "Fetching documents..."),
...
//               // if (state.fetchStatus == SubmitStatus.failure)
//               //   const Center(
//               //     child: Dialog(
//               //       child: Padding(
//               //         padding: EdgeInsets.all(16),
//               //         child: Text("Failed to fetch documents"),
//               //       ),
//               //     ),
//               //   ),
...
//               //       child: Text(state.uploadMessage),
//               //     ),
//               //   ),
//               // ),
//             ],
