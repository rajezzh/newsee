...
class SaveProfilePictureBloc extends Bloc<ProfilPictureEvent, ProfilPictureState> {
  ...
  Future<void> resetCustomerImage(ResetProfileDataEvent event, Emitter emit) async {
    print("Reset the customer Image Bloc functionalty works here");
    emit(ProfilPictureState(status: LeadStatus.reset, profilepicturedetails: null));
  }
