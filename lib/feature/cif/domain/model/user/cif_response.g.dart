...
CifResponse _$CifResponseFromJson(Map<String, dynamic> json) => CifResponse(
  ...
  depositCount: json['depositCount'] as String?,
  depositAmount: json['depositAmount'] as String?,
  liabilityCount: json['liabilityCount'] as String?,
  liabilityAmount: json['liabilityAmount'] as String?,
  cifFlag: json['cifFlag'] as String?,
  otheridno: json['otheridno'] as String?,
);
...
Map<String, dynamic> _$CifResponseToJson(CifResponse instance) =>
    <String, dynamic>{
      ...
      'liabilityCount': instance.liabilityCount,
      'liabilityAmount': instance.liabilityAmount,
