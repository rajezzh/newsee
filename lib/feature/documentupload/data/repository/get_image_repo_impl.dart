...
class GetImageRepoImpl extends FetchDocImageRepo {
  @override
  Future<AsyncResponseHandler<Failure, Map<String, dynamic>>>
  fetchDocumentImage({required Map<String, dynamic> request}) async {
    DocumentDataSource documentdatasource = DocumentDataSource(
      dio: ApiClient().getDio(),
    );

    var response = await documentdatasource.fetchUploadedDocument(request);
