...
class ResponseWidget extends StatelessWidget {
  ...
  ResponseWidget({required this.heightSize, required this.dataList, this.onpressed});
...
class ResponseWidgetList {
  ...
  String label;
  String value;
  ResponseWidgetList({required this.icon, required this.label, required this.value});
}
